...
if (menuX > guiWidth+150) && (menuCommitted != -1)
{
	switch (menuCommitted)
	{
		...
		case 2: default: room_goto(rmLevelSelect); score=0; break;
		case 1: room_goto(rmHowtoPlay); break;
