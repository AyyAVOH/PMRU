...
if (place_meeting(x, y+1, objSurface))
	...
	if (key_jump) && (jumps > 0)
	{
		//CODED OUT: audio_play_sound(sfx_Jump,1,false)
		jumps -= 1;
	 vsp = - jumpspeed;
	}
