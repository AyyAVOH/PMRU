...
if (menuControl)
{
	...
	{
		audio_play_sound(sfx_checkpoint,1,false);
...
if (menuX > guiWidth+150) && (menuCommitted != -1)
{
	switch (menuCommitted)
	{
		...
		case 1: default: instance_activate_object(objTimer); 
			instance_activate_object(objGameController); instance_destroy(); break;
		
		case 0: default: room_goto(rmMainMenu); break;
